...
if(isset($postdata) && !empty($postdata))
{
  // Extract the data.
    ...
    if($verify->rowCount())
    {
        $update = $con->prepare("UPDATE film SET nom = :nom, duree = :duree, genre = :genre, acteur = :acteur, realisateur = :realisateur, date = :date, note = :note, description = :description WHERE id = :id");
